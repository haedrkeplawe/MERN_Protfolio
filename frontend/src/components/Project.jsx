...
import image10 from "../image/prdouct_10.jpg";
...
const Project = () => {
  return (
    <div id="prject" className="project">
      <h2>My Project</h2>
      <p>
        Hint : when you visit any website wait 30s while backend work
        successfule
      </p>
      <div className="py-10 grid grid-cols-1 sm:grid-cols-2  gap-5 md:grid-cols-3 ">
        ...
        <Cart
          ...
          Name={"Tolibe"}
          discrption={
            "E-commerce : This website has been designed primarily to work on mobile phones."
          }
          skils={["react", "express", "mongodb"]}
          links={["https://tolibe.netlify.app/"]}
          linksName={["Tolibe"]}
        />
        <Cart
          image={image2}
